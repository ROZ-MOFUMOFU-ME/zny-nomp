> [!IMPORTANT]
> **Merged into [namp](https://github.com/ROZ-MOFUMOFU-ME/namp)** (NAMP — Node All-in-One Mining Portal). Development continues there as [`packages/portal`](https://github.com/ROZ-MOFUMOFU-ME/namp/tree/main/packages/portal) with full commit history. This repository is archived; the pre-TypeScript main survives as [`legacy-main`](https://github.com/ROZ-MOFUMOFU-ME/zny-nomp/tree/legacy-main).
